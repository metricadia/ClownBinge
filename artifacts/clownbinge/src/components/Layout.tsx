...
const CATEGORIES = [
  ...
  { id: "founders_pen",      label: "Founder's Pen" },
...
const PILL: Record<string, { on: string; off: string }> = {
  ...
  founders_pen:      { on: 'bg-white text-[#0B1930] shadow-md ring-2 ring-white/60 font-black', off: 'bg-white text-[#0B1930] hover:bg-slate-100 font-black' },
