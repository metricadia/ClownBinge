...
const CATEGORIES = [
  ...
  { id: "reasons_pen",      label: "Reason's Pen" },
...
const PILL: Record<string, { on: string; off: string }> = {
  ...
  reasons_pen:      { on: 'bg-[#3D1A00] text-white shadow-md ring-2 ring-[#3D1A00]/40 font-black', off: 'bg-[#3D1A00] text-white hover:bg-[#2E1400] font-black' },
