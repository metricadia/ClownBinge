        ...
        <div className="cb-container h-20 sm:h-24 flex items-center justify-between">
          ...
          >
            <div className="flex items-baseline gap-0">
              <span className="logo-text text-[1.7rem] sm:text-4xl text-white tracking-tight">Clown</span>
              <span className="logo-text text-[1.7rem] sm:text-4xl text-secondary tracking-tight">Binge</span>
              <span className="text-white/40 text-xl sm:text-3xl font-sans font-light mx-1.5 sm:mx-2">|</span>
              <span className="text-white/80 text-[0.95rem] sm:text-2xl font-sans font-semibold tracking-wider sm:tracking-widest uppercase">
                Newsroom
              </span>
            </div>
