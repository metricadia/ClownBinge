...
const BOOKS: FactBook[] = [
  {
    id: 1, vol: "Vol. 01",
    shortTitle: "The Manufactured Threat: 400 Years of Anti-Black Hate",
    fullTitle: "The Manufactured Threat: 400 Years of Anti-Black Hate — Debunking the Racist Lie of Native Black Criminality",
  ...
  },
  {
    ...
    summary: "When the Trump administration dismantled DEI programs, it framed the move as restoring merit. This FactBook compares the actual credentials of Obama-era versus Trump-era appointees across six agency positions, using Senate confirmation records, federal disclosures, and official biographies. The data answers the question on the cover.",
    bullets: [
