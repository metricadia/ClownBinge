      ...
      <div className="max-w-3xl mx-auto px-4 py-12 sm:py-20">
        ...
        <div className="rounded-xl border-l-4 px-6 py-5 mb-8 bg-primary/5" style={{ borderColor: "#1A3A8F" }}>
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            The Nevis LLC Act requires any foreign plaintiff seeking action against a Nevis-domiciled entity to post a cash bond of $100,000 (XCD equivalent) before proceedings can be initiated. This provision exists specifically to prevent meritless foreign litigation from functioning as a silencing mechanism.
          </p>
        </div>
        ...
        <div className="my-8 flex flex-col gap-4">
          {[
            ...
            },
            {
              ...
              body: "As a Nevis-domiciled entity with Icelandic data infrastructure, we do not respond to foreign extrajudicial data requests. We do not comply with National Security Letters, informal law enforcement requests, or private legal demands issued outside the jurisdiction of the High Court of St. Kitts and Nevis. We are not in a position to disclose reader data to foreign parties because our legal and technical architecture does not permit it. This is by design.",
            },
            {
