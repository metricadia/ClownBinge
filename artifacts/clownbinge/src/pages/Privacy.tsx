    ...
    <Layout>
      <div className="max-w-3xl mx-auto px-4 py-12" ref={(el) => { containerRef.current = el; }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-border rounded-xl overflow-hidden border border-border mb-10">
          {[
            { icon: <Shield className="w-3.5 h-3.5" />, label: "Legal Entity", value: "Metricadia Research, LLC" },
        ...
        <div className="space-y-5">
          <p className="text-base text-muted-foreground leading-relaxed">
            The ClownBinge newsroom and the Metricadia Research research archive are hosted exclusively on servers physically located in Iceland. This is the second layer of what we refer to as the Sovereign Moat: a dual-jurisdiction structure in which the legal entity operates from St. Kitts and Nevis and the physical data infrastructure operates from Iceland.
          </p>
          <p className="text-base text-muted-foreground leading-relaxed">
        ...
        <blockquote className="border-l-4 pl-6 py-1 my-8 italic text-lg text-muted-foreground" style={{ borderColor: "#F5C518" }}>
          ...
          <footer className="text-sm font-bold text-header mt-2 not-italic">-- Metricadia Research, LLC</footer>
        </blockquote>
        ...
        <div className="mt-10 pt-6 border-t border-border flex flex-col gap-2">
          <p className="text-xs text-muted-foreground font-mono">
            Metricadia Research, LLC -- ClownBinge.com
          </p>
          <p className="text-xs text-muted-foreground font-mono">
