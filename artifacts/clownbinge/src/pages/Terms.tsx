...
export default function Terms() {
  usePageSeoHead({
    ...
    description: "Citatious Terms of Service. Primary Source Analytics, LLC — verified accountability journalism platform.",
    path: "/terms",
    schemaType: "WebPage",
  });
  return (
    <Layout>
      <div className="cb-container py-16 sm:py-24 max-w-3xl mx-auto">
        <div className="prose prose-lg max-w-none text-foreground prose-headings:font-display prose-headings:font-bold prose-headings:text-header prose-p:leading-relaxed">
          ...
          <p>
            The original commentary, compilation, design, and structure of the Site (including the "Citatious" name and logo) are owned by Primary Source Analytics, LLC.
          </p>
          <p>
