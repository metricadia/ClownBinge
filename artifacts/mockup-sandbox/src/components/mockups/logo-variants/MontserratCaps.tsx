export function MontserratCaps() {
  return (
    <div style={{ background: "#1A3A8F", padding: "24px 32px", display: "flex", flexDirection: "column", gap: "6px", minHeight: "100vh" }}>
      <div style={{ display: "flex", alignItems: "baseline", gap: 0 }}>
        <span style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 900, fontSize: "2.1rem", color: "#F5C518", letterSpacing: "0.06em", textTransform: "uppercase" }}>Citatious</span>
        <span style={{ color: "rgba(255,255,255,0.35)", fontSize: "1.8rem", fontWeight: 300, margin: "0 10px", fontFamily: "sans-serif" }}>|</span>
      ...
      <p style={{ color: "rgba(255,255,255,0.4)", fontSize: "0.65rem", marginTop: "16px", fontFamily: "monospace" }}>↑ Montserrat Black, title case — bold, authoritative, masthead energy</p>
    </div>
  );
}
