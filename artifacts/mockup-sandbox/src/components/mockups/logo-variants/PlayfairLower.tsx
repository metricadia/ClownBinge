export function PlayfairLower() {
  return (
    <div style={{ background: "#1A3A8F", padding: "24px 32px", display: "flex", flexDirection: "column", gap: "6px", minHeight: "100vh" }}>
      <div style={{ display: "flex", alignItems: "baseline", gap: 0 }}>
        <span style={{ fontFamily: "'Playfair Display', serif", fontWeight: 800, fontSize: "2.4rem", color: "#F5C518", letterSpacing: "-0.02em" }}>citatious</span>
        <span style={{ color: "rgba(255,255,255,0.35)", fontSize: "1.8rem", fontWeight: 300, margin: "0 10px" }}>|</span>
      ...
      <p style={{ color: "rgba(255,255,255,0.4)", fontSize: "0.65rem", marginTop: "16px", fontFamily: "monospace" }}>↑ Current — Playfair Display, lowercase</p>
    </div>
  );
}
