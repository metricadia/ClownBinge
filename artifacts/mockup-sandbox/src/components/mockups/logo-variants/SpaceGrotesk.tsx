  ...
  return (
    <div style={{ background: "#1A3A8F", padding: "24px 32px", display: "flex", flexDirection: "column", gap: "6px", minHeight: "100vh" }}>
      <div style={{ display: "flex", alignItems: "baseline", gap: 0 }}>
        <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: "2.5rem", color: "#F5C518", letterSpacing: "-0.03em" }}>citatious</span>
      ...
      <p style={{ color: "rgba(255,255,255,0.4)", fontSize: "0.65rem", marginTop: "16px", fontFamily: "monospace" }}>↑ Space Grotesk, lowercase — modern, geometric, tech-forward</p>
    </div>
  );
}
