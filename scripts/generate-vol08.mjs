...
import {
  ...
  convertInchesToTwip, BorderStyle, ShadingType,
  TableOfContents, StyleLevel, Tab, TabStopType,
  TabStopLeader, UnderlineType, PageNumber,
  NumberFormat, Footer, Header,
} from 'docx';
...
const src = readFileSync(
  join(ROOT, 'artifacts/clownbinge/src/pages/Bookstore.tsx'),
  'utf8'
);
...
const coverImageBuffer = readFileSync(
  join(ROOT, 'artifacts/clownbinge/public/covers/vol08-cover.png')
);
...
const outPath = join(ROOT, 'artifacts/clownbinge/public/Vol08-AncientFaith-ModernPolitics.docx');
