...
const samplePosts = [
  {
    ...
    body: `The Congressional Record is a merciless document. It does not forget. It does not forgive. It does not accept amendments retroactively. And on March 15, 2023, it captured Senator James Whitmore of Missouri doing exactly the thing he now insists, under oath of public performance, he never did.
...
Four months later, during a town hall in Springfield, Missouri, a constituent asked Whitmore directly about his vote on rural broadband funding — a provision contained within S.1247. The Senator's response, captured on video by three separate attendees: "I never supported that bill. I voted against government overreach every single time."

The C-SPAN archive of the Senate floor that March afternoon tells a different story. The audio is clear. The timestamp is precise. The vote count is verified. Senator Whitmore, at 2:47 PM Eastern, cast an affirmative vote for S.1247.

This is the anatomy of a political self-own: a public official, operating under the assumption that his constituency does not have access to the same public records he generates, making a claim that is contradicted by those very records. The assumption is wrong. ClownBinge is here to prove it.
...
The receipts do not have a political agenda. They have dates.`,
  ...
  },
  {
    ...
    body: `C-SPAN has been recording Congress since 1979. Forty-five years of floor speeches, committee hearings, and the kind of candid moments that occur when someone forgets the red light is blinking. Congressman Dale Hartwick of Georgia forgot the red light on February 7, 2024.

The clip runs three minutes and forty-two seconds. It is timestamped, archived, and indexed in the C-SPAN database under House Judiciary Committee proceedings. In it, Congressman Hartwick, speaking to a colleague during what he believed was a recess break, articulates a position on immigration enforcement that is substantially different from the position he articulates in his official press releases, his constituent newsletters, and his campaign website.

"It was taken out of context," his communications director told reporters on February 9th. The C-SPAN clip contains no context gap. It is a continuous, unedited recording. The context is the context.

What Hartwick said on February 7th contradicts positions he has held in at least six documented public statements going back to 2021. ClownBinge has reviewed each statement. The Congressional Record contains the floor speeches. The C-SPAN archive contains the committee appearances. The official website contains the press releases. They do not agree with each other or with the February 7th recording.

The public record is comprehensive. It covers everything from his 2022 primary campaign, during which he described himself as "the strongest border hawk in this delegation," to the February 7th moment in which he described his own enforcement legislation as "political theater for the base."
...
These are not two interpretations of a complicated policy position. They are two contradictory statements from the same person, both captured on video, both entered into the public record.`,
  ...
  },
  {
    ...
    body: `Attorney General Rick Donahue of Texas filed a 47-page lawsuit on March 3, 2024, targeting a business practice he characterized as "a flagrant abuse of regulatory frameworks designed to protect working families." The lawsuit, filed against a national insurance consortium, argues that the practice constitutes fraud under Texas consumer protection statutes.
...
The Texas State Bar Association's public database contains his firm's case filings from that period. They are not sealed. They have not been expunged. They include the names of the clients, the nature of the representation, and in several instances, detailed memos describing the practice's legal architecture — the same architecture his lawsuit now calls fraudulent.

Donahue's press release announcing the lawsuit describes it as "a historic action to protect Texas families from predatory corporate behavior." The 2019 memo from his private firm, obtained through public records, describes the same behavior as "a legally sound structure consistent with industry standards and fully compliant with applicable state law."
...
The receipts do not adjudicate the legal merits of either position. They document that both positions belong to the same person.`,
  ...
  },
  {
    ...
    title: "Anti-Immigration Pastor Discovered to Have Immigrant Grandparents — Both Sides",
    ...
    body: `Pastor Vernon Mills of Cornerstone Fellowship Church in Scottsdale, Arizona, has delivered seventeen documented sermons on immigration since 2020. ClownBinge has reviewed each one. The consistent argument: America is a nation founded on specific principles of cultural continuity, and unrestricted immigration from certain regions constitutes a demographic threat to those principles.
...
All four of Vernon Mills' grandparents were immigrants. Two entered on work visas. Two entered as refugees. All four became American citizens. Vernon Mills is an American citizen because four immigrants were allowed into the United States of America.
...
The genealogical records are public. The sermon is public. The contradiction is complete.`,
  ...
  },
  {
    ...
    body: `The Palmetto County School Board voted 5-2 on August 14, 2023, to remove 23 books from district library shelves. Board member Patricia Holden was among the five affirmative votes. The removal list includes titles related to civil rights history, LGBTQ+ experiences, and what the board's resolution describes as "ideologically targeted diversity programming."

The University of Southern California's Office of Admission published its Class of 2027 enrollment announcements in May 2023. Among the incoming students: Emma Holden of Palmetto County, South Carolina. The university's website describes its first-year experience as including "a robust diversity and inclusion orientation curriculum" and "equity-focused residential programming."

Emma Holden's enrollment deposit was submitted April 14, 2023, four months before her mother's August vote on the library ban.
...
ClownBinge makes no judgment about Emma Holden, who is a private individual and is not the subject of this piece. The subject is Patricia Holden, a public official who made a public vote, and the documented relationship between that vote and her private family choices.`,
  ...
  },
  {
    ...
    body: `On August 18, 2022, officers from the Adams County Sheriff's Office in Ohio executed a search warrant at the home of Joseph Foreman, known professionally as Afroman. The officers were looking for evidence of drug trafficking and kidnapping. They found no drugs. They found no kidnapping victims. They found a man making music in his home.

What they did not find, but what Afroman had: extensive surveillance footage of the entire raid.

He did what any reasonable person with a fully operational creative practice and an ironclad fair use argument would do. He used the footage. He released a series of music videos — "Lemon Pound Cake," "Will You Help Me Repair My Door," "Poker Face" — each featuring footage of the officers searching his home. The videos were nominated for Grammy awards. That sentence is not a joke. The Recording Academy nominated surveillance footage of an unlawful raid repurposed as music video content for Grammy consideration.

The Adams County deputies, who appeared in the videos without their consent, sued Afroman for invasion of privacy, emotional distress, and interference with potential future law enforcement employment. They sued the man whose home they searched, using footage of themselves, taken in his home, during an unsuccessful operation.

The lawsuit was dismissed. Afroman counter-sued. And then he opened a store selling merch featuring the officers' images from the videos. And then he used footage from the raid in a museum exhibition about civil rights and police accountability.
