...
async function seed() {
  ...
  await db
    ...
    .values({
      ...
      title: "Absurd: Sen. Ted Cruz Claims 'Christ is King' is Anti-Jewish. Yes He Actually Said it.",
